...
from abrechnung_verbrauch import AbrechnungVerbrauchMaterial as avm
from abrechnung_verbrauch import AbrechnungVerbrauchPerson as avp
# import AbrechnungAlteDaten as avad
from abrechnung_verbrauch import AbrechnungVerbrauchAuflisten as ava
...
#-------------------------------------------------------------------------------
  ...
  #             ['section1',     'varname1',          typ1,             set_default1,  'default1']
  INIVARLIST = [[u'allg',        u'logfile',          hdef.DEF_STR,     1,             u'log.txt'      ] \
               ,[u'allg',        u'dbdeffile',        hdef.DEF_STR,     1,             u'bddef.txt'    ] \
               ,[u'allg',        u'dbdatafile',       hdef.DEF_STR,     1,             u'dbdata.sql'   ] \
               ,[u'allg',        u'backup_flag',      hdef.DEF_INT,     1,             0               ] \
               ,[u'allg',        u'backup_dir',      hdef.DEF_STR,      1,             u''             ] \
               ]
...
#-------------------------------------------------------------------------------
  def __del__(self):
    ...
    try:
      ...
      print("self.dbh.close() was not possible")
...
#-------------------------------------------------------------------------------
  def close_log_file(self):
    try:
      ...
      print("self.log.write_e() was not possible")
