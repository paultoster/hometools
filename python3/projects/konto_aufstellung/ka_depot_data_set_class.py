...
class DepotDataSet:
    ...
    DEPOT_DATA_INDEX_ID: int = 0
    DEPOT_DATA_INDEX_ISIN: int = 1
    DEPOT_DATA_INDEX_BUCHDATUM: int = 2
    DEPOT_DATA_INDEX_WERTDATUM: int = 3
    DEPOT_DATA_INDEX_BUCHTYPE: int = 4
    DEPOT_DATA_INDEX_WERT: int = 5
    DEPOT_DATA_INDEX_SUMWERT: int = 6
    DEPOT_DATA_INDEX_COMMENT: int = 7
    DEPOT_DATA_INDEX_CHASH: int = 8
    DEPOT_DATA_INDEX_KATEGORIE: int = 9
    
    
    
    DEPOT_DATA_INDEX_LIST = [DEPOT_DATA_INDEX_ID, DEPOT_DATA_INDEX_ISIN, DEPOT_DATA_INDEX_BUCHDATUM, DEPOT_DATA_INDEX_WERTDATUM
                            ,DEPOT_DATA_INDEX_BUCHTYPE, DEPOT_DATA_INDEX_WERT
                            ,DEPOT_DATA_INDEX_SUMWERT, DEPOT_DATA_INDEX_COMMENT, DEPOT_DATA_INDEX_CHASH
                            ,DEPOT_DATA_INDEX_ISIN, DEPOT_DATA_INDEX_KATEGORIE]
    
    DEPOT_DATA_INMUTABLE_INDEX_LIST = [DEPOT_DATA_INDEX_ID,DEPOT_DATA_INDEX_BUCHTYPE,DEPOT_DATA_INDEX_CHASH]
    
    DEPOT_BUCHTYPE_TEXT_LIST = ["unbekannt",
                                "wp_kauf",
                                "wp_verkauf",
                                "wp_kosten",
                                "wp_einnahmen"]
    # BUchungs Typ
    DEPOT_BUCHTYPE_UNBEKANNT: int     = 0
    DEPOT_BUCHTYPE_WP_KAUF: int       = 1
    DEPOT_BUCHTYPE_WP_VERKAUF: int    = 2
    DEPOT_BUCHTYPE_WP_KOSTEN: int     = 3
    DEPOT_BUCHTYPE_WP_EINNAHMEN:int   = 4
    
    DEPOT_DATA_BUCHTYPE_DICT          = { DEPOT_BUCHTYPE_UNBEKANNT: DEPOT_BUCHTYPE_TEXT_LIST[DEPOT_BUCHTYPE_UNBEKANNT]
                                        , DEPOT_BUCHTYPE_WP_KAUF: DEPOT_BUCHTYPE_TEXT_LIST[DEPOT_BUCHTYPE_WP_KAUF]
                                        , DEPOT_BUCHTYPE_WP_VERKAUF: DEPOT_BUCHTYPE_TEXT_LIST[DEPOT_BUCHTYPE_WP_VERKAUF]
                                        , DEPOT_BUCHTYPE_WP_KOSTEN: DEPOT_BUCHTYPE_TEXT_LIST[DEPOT_BUCHTYPE_WP_KOSTEN]
                                        , DEPOT_BUCHTYPE_WP_EINNAHMEN: DEPOT_BUCHTYPE_TEXT_LIST[DEPOT_BUCHTYPE_WP_EINNAHMEN]
                                        }
    ...
    def __init__(self):
        self.DEPOT_DATA_HEADER_CSV_NAME_DICT = {}
        self.DEPOT_DATA_HEADER_ABFRAGE_DICT = {}
    
        self.DEPOT_DATA_BUCHTYPE_CSV_NAME_DICT = {}
    ...
    def set_buchtype_csv_name(self,buchtype_index: int,buchtype_dict_csv_name: str | list):
        self.DEPOT_DATA_BUCHTYPE_CSV_NAME_DICT[buchtype_index] = buchtype_dict_csv_name
    # enddef
