...
class Parameter:
    ...
    INI_BASE_PROOF_LISTE = [(INI_KONTO_DATA_DICT_NAMES_NAME,"list_str")
                           ...
                           ,(INI_LOG_SCREEN_OUT_NAME,"str"),(INI_IBAN_LIST_FILE_NAME,"str")]
    ...
    INI_IMPORT_DATA_CONFIG_NAME: str = "import_data_type"
    ...
    INI_KONTO_PROOF_LISTE = [(INI_IBAN_NAME, "iban")
                            ...
                            , (INI_IMPORT_DATA_CONFIG_NAME, "str")]
...
def get(log):
    ...
    p.LOG_SCREEN_OUT = log.GUI_SCREEN + log.PRINT_SCREEN
