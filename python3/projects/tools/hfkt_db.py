...
#       und diesen datansatz gelï¿½scht
#
...
def get_data_type_number(datatypename):
  """
  vergleicht datatypename mit Definition und gibt Integer-Wert zurï¿½ck
  Wenn nicht vorhanden wird None zurï¿½ck gegeben
  """
...
##    """
##    Gibt die Tabelle aus Liste zurï¿½ck
##    """
...
##    """
##    Gibt die Zelle aus Tabelle aus Liste zurï¿½ck
    ...
    if( self.exist_table(deftabname) ):
      if( not self.exist_cell(deftabname,defcellname) ):
        ...
        if( defcelldatatype == DB_DATA_TYPE_PRIMKEY ):
          self.errText = "In Tabelle:<%s> kann keine Zelle: <%s> mit Typ DB_DATA_TYPE_PRIMKEY hinzugefï¿½gt werden " % (deftabname,defcellname)
          self.status = self.NOT_OKAY
        else:
          ...
          if(  (defcelldatatype == DB_DATA_TYPE_DATUM) \
              ...
              or (defcelldatatype == DB_DATA_TYPE_CENT)\
              ):
...
#============================================================================================================================
  def get_num_of_items(self,tabname):
    """
    Wieviele DAtensï¿½tze entahlaten
    """
    try:
      # sqlite Kommando ausfï¿½hren
      #--------------------------------
...
#-------------------------------------------------------------------------------
  def exist_data_in_tab(self,tabname,cellname,cellvalue):
    """
    Prï¿½ft Existenz der Zelle mit dem Zellenwert in der Tabelle
