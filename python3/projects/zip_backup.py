# -*- coding: cp1252 -*-
# 14.02.10 neue Version mit geänderter mtime
# 12.02.10 erste kommentierte Version
# Klasse Backup:
# Der Klasse Backup wird ein dictionary übergeben mit
...
# so daß bei einem wiederholtem Aufruf nur das Target-Verzeichnis angegeben werden
# muß.
# Die Ausschlußpfade sind relativ oder absolut und beziehen sich auf das source-Verzeichnis
# Beispiel einschlieslich Initialisieren der Klasse und Backup ausführen
#-----------------------------------------------------------------------------
# import sys
...
# dict["max_backups"]  = 2
# # Prüft den target path, ob alle zip-Files eine Zuordnung zu den versionen hat
# # wenn nein löschen
...
#
#--------------------------------
# Die dictionary-Namen können durch die Variablen geändert werden:
# A_TARGET_PATH, A_SOURCE_PATH, A_EXCLUDE_PATH, A_EXCLUDE_EXT
#
# Zussätzlich zu ZipBackup.py muß
# hilfsfkt.py vorhanden sein
#
# BeimAusführen des Backups wird beim erstenmal eine Versiondatei im target_path
# erstellt, bei weiteren ausführen wird die Versionsdatei eingelesen
# Die Versionsdatei enthält ein dictionary und wird in D eingelesen
#
...
# D["exclude_path"] (list)  Liste mit den Ausschlußpfaden absolut
# D["exclude_path_rel"] (list)  Liste mit den Ausschlußpfaden relativ
# D["exclude_ext"] (list)   Liste mit den Ausschlußextentions
...
#                             ]
#
#                             versions_liste enthält Versionsnummer
#                             mtime_liste    enthält die Zeit time.time()
#                             exist_liste    enthält True (existiert)oder False (existiert nicht)
#
#                             Die Länge der Liste ist die Anzahl der Versionen, die gespeichert sind
#
...
##############################################################################
class Proof:
    """ Überprüfen des gezippten Archives durch Vergleich mit
