function q = build_vcproj_for_mex_sim_modul_io(q)

  % Behandlung sim_MODUL_SIM.cpp
  q = build_vcproj_for_mex_sim_modul_io_sim_modul(q);
  % Behandlung fkt_MODUL_SIM.cpp
  q = build_vcproj_for_mex_sim_modul_io_fkt(q);
end
function q = build_vcproj_for_mex_sim_modul_io_sim_modul(q)
