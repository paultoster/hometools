...
n_data = duh_das2_daten_wandeln_do_f(s_liste(1).c_value,s_liste(2).c_value,s_liste(3).c_value{1},s_liste(4).c_value{1}, ...
...
function   n_data = duh_das2_daten_wandeln_do_f(c_dir, c_prc_files, peak_filt_flag,peak_filt_std_fac, ...
