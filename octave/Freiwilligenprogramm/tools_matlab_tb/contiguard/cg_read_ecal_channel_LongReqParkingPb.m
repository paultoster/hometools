function e = cg_read_ecal_channel_LongReqParkingPb(d,channel_name)
  ...
  sigliste     = {{'acc_req_demand'        , 1,'enum'  ,'int'     ,0,'0:ACC_NO_REQUEST,1:ACC_COMFORT_DECEL,2:ACC_EMERGENCY_DECEL'} ...
