function e = cg_read_ecal_channel_DrvCtrlStrAngRequestPb(d,channel_name)
  ...
  sigliste     = {{'steering_angle_request_value'  , 1,'rad'    ,'double' , 1, ''} ...
                 ,{'lateral_control_priority'      , 1,'enum'   ,'int'    , 0, ''} ...
                 ,{'lateral_control_quality'       , 1,'enum'   ,'int'    , 0, ''} ...    
                 ,{'active'                        , 1,'enum'   ,'int'    , 0, ''} ...    
                 };
