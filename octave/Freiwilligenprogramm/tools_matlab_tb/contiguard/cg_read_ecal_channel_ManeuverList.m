function e = cg_read_ecal_channel_ManeuverList(d,channel_name)
  ...
  sigliste     = {{'states.velocity_mps'    , 1,'m/s'     ,'double'     ,0,''} ...
                 ,{'states.distance_m'   , 1,'m'     ,'double'     ,0,''} ...     
                 ,{'states.timestamp_ms' , 1,'ms'     ,'double'     ,0,''} ...  
                 ,{'actions.velocity_mps'    , 1,'m/s'     ,'double'     ,0,''} ...
                 ,{'actions.time_ms'    , 1,'ms'     ,'double'     ,0,''} ...
                 };                 
