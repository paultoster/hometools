function e = cg_read_ecal_channel_ParkScenarioRequestPb(d,channel_name)
  ...
  sigliste     = {{'request'             , 1,'enum'  ,'int'    ,0,''} ...
                 ,{'targetPosition.x'    , 1,'m'     ,'double' ,0,''} ...
                 ,{'targetPosition.y'    , 1,'m'     ,'double' ,0,''} ...
                 ,{'targetYawAngle'      , 1,'rad'   ,'double' ,0,''} ...
                 ,{'waypoint_req_id'     , 1,'enum'   ,'int' ,0,''} ...
                 ,{'waypoint_req_action' , 1,'enum'   ,'int' ,0,''} ...                 
                 };
