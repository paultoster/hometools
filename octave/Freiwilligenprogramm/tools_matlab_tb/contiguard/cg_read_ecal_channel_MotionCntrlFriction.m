function e = cg_read_ecal_channel_MotionCntrlFriction(d,channel_name)
  ...
  sigliste     = {{'friction_act'         , 1,'-'     ,'double'     ,0,''} ...
                 ,{'friction_act_valid'   , 1,'-'     ,'int'        ,0,''} ...     
                 ,{'friction_probability' , 1,'%'     ,'double'     ,0,''} ...     
                 ,{'black_ice_detected'   , 1,'-'     ,'int'     ,0,''} ...     
                 };                 
