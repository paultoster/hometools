function e = cg_read_ecal_channel_WheelTicksInPb(d,channel_name)
  ...
  sigliste     = {{'Signals.ticks_fl'      , 1,'-'  ,'int'     ,0,''} ...
                 ,{'Signals.ticks_fr'      , 1,'-'  ,'int'     ,0,''} ...
                 ,{'Signals.ticks_rl'      , 1,'-'  ,'int'     ,0,''} ...
                 ,{'Signals.ticks_rr'      , 1,'-'  ,'int'     ,0,''} ...
                 };                 
