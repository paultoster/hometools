function eout = cg_read_tacc_channel_ESA2VehDsrdTraj(e)
  ...
  % 1. Suche x-Vektor
  s = ESA2VehDsrdTraj_get_channel_vec(e, c_names, n ...
                           ,'ESA2VehDsrdTraj_pointFrnt_mBuffer_' ...
                           ,'x' ...
                           ,'ESA2VehDsrdTraj_pointFrnt_mBufferCnt');  
                          
  eout = ESA2VehDsrdTraj_set_channel_struct(eout,s ...
                               ,'ESA2VehDsrdTraj_pointFrnt_x' ...
                               ,'m' ...
                               ,'');
  % 2. Suche y-Vektor
  [s] = ESA2VehDsrdTraj_get_channel_vec(e, c_names, n ...
  ...
  eout = ESA2VehDsrdTraj_set_channel_struct(eout,s ...
                                  ,'ESA2VehDsrdTraj_pointFrnt_y' ...
                                  ,'m' ...
                                  ,'');

  % 3. Suche c0-Vektor
  [s] = ESA2VehDsrdTraj_get_channel_vec(e, c_names, n ...
                           ,'ESA2VehDsrdTraj_curve_mBuffer_' ...
                           ,'c0' ...
                           ,'ESA2VehDsrdTraj_curve_mBufferCnt');  
                          
  eout = ESA2VehDsrdTraj_set_channel_struct(eout,s ...
                                  ,'ESA2VehDsrdTraj_curve_c0' ...
                                  ,'1/m' ...
                                  ,'');
  ...
  [eout] = ESA2VehDsrdTraj_set_channel_struct(eout,s ...
                                  ,'ESA2VehDsrdTraj_curve_ds' ...
                                  ,'m' ...
                                  ,'');

end
function  s = ESA2VehDsrdTraj_get_channel_vec(e,c_names,n,vecname_vor,vec_name,nvec_name)
...
function   [e1] = ESA2VehDsrdTraj_set_channel_struct(e1,s,struct_name,struct_unit,struct_comment)
