function e = cg_read_ecal_channel_MotionCntrlPlannerRequestPb(d,channel_name)
  ...
  sigliste     = {{'motion_cntrl_planner_request'  , 1,'enum'  ,'int'   ,0,'0:no,1:idle,2:rec,3:recstop,4:start,5:stop,6:save,7:runman,8:runsavestop'} ...
                 ,{'traj_to_load_index'  , 1,'enum'  ,'int'   ,0,''} ...
                 ,{'use_mpc'  , 1,'enum'  ,'int'   ,0,''} ...                 
                 };
