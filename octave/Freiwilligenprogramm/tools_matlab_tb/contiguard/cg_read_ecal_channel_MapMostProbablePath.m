function e = cg_read_ecal_channel_MapMostProbablePath(d,channel_name)
  ...
  sigliste     = {{'ways.nodes'             , 1,'enum'  ,'int',1,''} ...
                 ,{'ways.way'               , 1,'enum'  ,'int',0,''} ...
                 ,{'ways.probability'       , 1,'-'     ,'double',1,''} ...
                 ,{'mapTimestamp'           , 1,'us'    ,'double',1,''} ... 
                 ,{'waysBefore.nodes'             , 1,'enum'  ,'int',1,''} ...
                 ,{'waysBefore.way'               , 1,'enum'  ,'int',0,''} ...
                 ,{'waysBefore.movingUpwards'     , 1,'enum'  ,'int',0,''} ...
                 ,{'waysBefore.probability'       , 1,'-'     ,'double',1,''} ...
                 };
...
%           yspline_vec: [15x1 double]
  ...
  for j=1:ndata
    timestamp(j) = d.data{j}.timestamp;
  end
