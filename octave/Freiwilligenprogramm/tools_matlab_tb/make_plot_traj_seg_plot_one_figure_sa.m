%==========================================================================
%  Plaot avec over svec
%==========================================================================
function    q = make_plot_traj_seg_plot_one_figure_sa(seg,nseg,q)
  q.fig_num       = q.fig_num + 1;
  q.nplo          = q.nplo + 1;
  
  plo.h_figure    = p_figure(q.fig_num,q.dina4,'onePlotSA');
  plo.clegText    = {};
  ...
  for iseg=q.iseg0:q.iseg1
    ...
    plo = make_plot_traj_seg_plot_figure_sa_seg(plo,seg,iseg,q);
  ...
  for iseg=q.iseg0:q.iseg1
    ...
    plo = make_plot_traj_seg_plot_figure_wol_sa_seg(plo,seg,iseg,q);
