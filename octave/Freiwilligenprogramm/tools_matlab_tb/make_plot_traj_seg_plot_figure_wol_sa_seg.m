function plo = make_plot_traj_seg_plot_figure_wol_sa_seg(plo,seg,iseg,q)
  ...
  if( iseg == q.iseg_t0 )
   plo = make_plot_traj_seg_plot_figure_sa_seg_egoPosCross(plo,seg(iseg).egoPos(1),q.Axle,q);
  end
