function vc_mex_m_file = VC11_build_vc_mex(proj_name,vc_proj_file,outdir,configname)
%
% vc_mex_m_file = VC11_buid_vc_mex(outdir,vc_proj_file,configname)
%
...
%
  vcvarsall_file = 'C:\Program Files (x86)\Microsoft Visual Studio 11.0\VC\vcvarsall.bat';
  % devenv_file    = 'C:\Program Files (x86)\Microsoft Visual Studio 9.0\Common7\IDE\VCExpress.exe';
  devenv_file    = 'C:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE\devenv.exe';
